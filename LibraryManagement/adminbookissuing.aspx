         ...
         <div class="col-md-5">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-6">
                        <asp:Button ID="Button2" Width="100%" class="btn btn-lg btn-block btn-primary" runat="server" Text="Issue" />
                     </div>
                     <div class="col-6">
                        <asp:Button ID="Button4" Width="100%" class="btn btn-lg btn-block btn-success" runat="server" Text="Return" />
                     </div>
                  </div>
               </div>
            </div>
